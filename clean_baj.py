...
ref = re.compile(r"(\s|^)(forsenE|fors|forsen|forsens|forsen's|@[\w\d_-]+)(\s|\.|,|;|:|!|\?|$)")
rep = re.compile(r"(u/|r/|reddit|upvot|pedo|vadikus|weebikus|downvot|baj|peppah|forsa+n|hitler)")
