...
ref = re.compile(r"(\s|^)(forsenE|fors|forsen|forsens|forsen's|nina|nani|@[\w\d_-]+|xqc|sub|subs|sub's)(\s|\.|,|;|:|!|\?|$)")
rep = re.compile(r"(u/|r/|reddit|upvot|pedo|vadikus|weebikus|downvot|baj|peppah|forsa+n|hitler|mong|asylum|eloise)")
